...
class MutantInsect:
  ...
  def __init__(self, screen_width, screen_height, olives):
    ...
    self.speed = 1  # Movement speed in pixels per frame
    ...
    self.image = pygame.transform.scale(pygame.image.load("images/mutant_insect.png"), (self.size, self.size))
